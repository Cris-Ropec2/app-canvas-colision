(() => {
    ...
    function initMain() {
        ...
        window_width = parseInt(document.getElementById("w-main").value);
        window_height = parseInt(document.getElementById("h-main").value);
        let numCirculos = parseInt(document.getElementById("n-main").value);
